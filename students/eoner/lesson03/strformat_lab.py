...
print(string_format((4, 30, 2017, 2, 27)))
...
print(fruity(['oranges', 1.3, 'lemons', 1.1]))
...
print(fruity_two(['oranges', 1.3, 'lemons', 1.1]))
...
def print_fancy(list):
    header = str("{} {:>10} {:>10}{:>15}".format(
        "Brand", "Model", "HP", "Price"))
    print(header)
