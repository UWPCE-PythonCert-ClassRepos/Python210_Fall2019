...
def test_append():
    ...
    """
    e = Element("this is TEST some text")
    e.append("and this is TEST some more text")
...
#  TODO Get this one too work someday...
#def test_attributes():
...
#    # but make sure the embeded element's tags get rendered.
