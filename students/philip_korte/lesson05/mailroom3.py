        ...
        if donation == 'q':
            ...
            while True:
                try:
                    ...
                    break
            donors[person].append(donation)  # add amount to donation history
            write_letter(person, donation)  # write a thank you note
...
def send_thanks_all():
    [write_letter(person, sum(donation), True) for person, donation in donors.items()]
